  ...
  <section class="flex flex-col-reverse md:grid md:grid-cols-12 gap-4">
    ...
    <div v-else class="md:col-span-7 flex flex-col gap-4">
      <Offer
         ...
         :listing-sold-at="listing.sold_at != null"
       />
    </div>
    <div class="md:col-span-5">
      <Box>
      <template #header>Basic Info</template>
      <Price :price="listing.price" class="text-2xl font-bold block mt-1" />
...
import Offer from "@/Pages/Realtor/Show/Component/Offer.vue";
